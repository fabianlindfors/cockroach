...
type LegacyTimestamp struct {
	...
	WallTimeUpperBound int64 `protobuf:"varint,4,opt,name=wall_time_upper_bound,json=wallTimeUpperBound" json:"wall_time_upper_bound"`
}
...
var fileDescriptor_3bf5feed19a38215 = []byte{
	...
	,
	...
	0x9c, 0x91, 0x93, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x39, 0xcd, 0x80, 0x3e, 0x2e, 0x01, 0x00,
	0x00,
}
...
func (this *LegacyTimestamp) Equal(that interface{}) bool {
	...
	if this.WallTimeUpperBound != that1.WallTimeUpperBound {
		return false
	}
	return true
}
...
func (m *LegacyTimestamp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintLegacyTimestamp(dAtA, i, uint64(m.WallTimeUpperBound))
	i--
	dAtA[i] = 0x20
	if m.Synthetic != nil {
		i--
...
func NewPopulatedLegacyTimestamp(r randyLegacyTimestamp, easy bool) *LegacyTimestamp {
	...
	this.WallTimeUpperBound = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.WallTimeUpperBound *= -1
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *LegacyTimestamp) Size() (n int) {
	...
	n += 1 + sovLegacyTimestamp(uint64(m.WallTimeUpperBound))
	return n
}
...
func (m *LegacyTimestamp) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field WallTimeUpperBound", wireType)
			}
			m.WallTimeUpperBound = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowLegacyTimestamp
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.WallTimeUpperBound |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
