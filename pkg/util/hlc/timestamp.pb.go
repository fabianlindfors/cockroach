...
type Timestamp struct {
	...
	WallTimeUpperBound int64 `protobuf:"varint,4,opt,name=wall_time_upper_bound,json=wallTimeUpperBound,proto3" json:"wall_time_upper_bound,omitempty"`
}
...
var fileDescriptor_7f15827ff64414ad = []byte{
	...
	0x58, 0x10, 0x95, 0x4a, 0x0b, 0x19, 0xb9, 0x38, 0x43, 0x60, 0xba, 0x85, 0xa4, 0xb9, 0x38, 0xcb,
	...
	0x92, 0xcc, 0x64, 0x09, 0x66, 0x05, 0x46, 0x0d, 0x8e, 0x20, 0x84, 0x80, 0x90, 0x21, 0x97, 0x28,
	0xdc, 0xd0, 0xf8, 0xd2, 0x82, 0x82, 0xd4, 0xa2, 0xf8, 0xa4, 0xfc, 0xd2, 0xbc, 0x14, 0x09, 0x16,
	0xb0, 0x05, 0x42, 0x30, 0x0b, 0x42, 0x41, 0x52, 0x4e, 0x20, 0x19, 0x2b, 0x9e, 0x19, 0x0b, 0xe4,
	0x19, 0x76, 0x2c, 0x90, 0x67, 0x7c, 0xb1, 0x40, 0x9e, 0xd1, 0x49, 0xf5, 0xc4, 0x43, 0x39, 0x86,
	0x13, 0x8f, 0xe4, 0x18, 0x2f, 0x3c, 0x92, 0x63, 0xbc, 0xf1, 0x48, 0x8e, 0xf1, 0xc1, 0x23, 0x39,
	0xc6, 0x09, 0x8f, 0xe5, 0x18, 0x2e, 0x3c, 0x96, 0x63, 0xb8, 0xf1, 0x58, 0x8e, 0x21, 0x8a, 0x39,
	0x23, 0x27, 0x39, 0x89, 0x0d, 0xec, 0x23, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xae, 0x3d,
	0x51, 0xbc, 0x17, 0x01, 0x00, 0x00,
}
...
func (m *Timestamp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.WallTimeUpperBound != 0 {
		i = encodeVarintTimestamp(dAtA, i, uint64(m.WallTimeUpperBound))
		i--
		dAtA[i] = 0x20
	}
	if m.Synthetic {
...
func (m *Timestamp) Size() (n int) {
	...
	if m.WallTimeUpperBound != 0 {
		n += 1 + sovTimestamp(uint64(m.WallTimeUpperBound))
	}
	return n
}
